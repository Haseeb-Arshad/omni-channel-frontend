...
const sidebarItems = [
    { icon: LayoutDashboard, label: "Overview", href: "/minimal/dashboard" },
    { icon: Database, label: "Knowledge Base", href: "/minimal/dashboard/knowledge" },
    { icon: Users, label: "AI Personas", href: "/minimal/dashboard/personas" },
    { icon: Share2, label: "Channels", href: "/minimal/dashboard/channels" },
    { icon: Bot, label: "Agents", href: "/minimal/dashboard/agents" },
    { icon: MessageSquare, label: "Communication", href: "/minimal/dashboard/communication" },
];
