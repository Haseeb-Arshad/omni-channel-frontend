        ...
        <div className="relative z-20 flex flex-col justify-center items-center h-full text-white p-12">
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className="text-xl opacity-80">Start your omni-channel journey today.</p>
            </motion.div>
            ...
            <motion.div variants={containerVariants} className="space-y-6">
              ...
              {[
                { 
                  ...
                  desc: "Quick and easy signup process to get started" 
                },
                { 
                  icon: <User className="h-5 w-5" />, 
                  title: "Personalized Dashboard", 
                  desc: "Access all your channels in one intuitive interface" 
                },
                { 
                  icon: <ArrowRight className="h-5 w-5" />, 
                  title: "Ready to Go", 
                  desc: "Start connecting with customers right away" 
                }
              ].map((feature, i) => (
                <motion.div 
                  key={i} 
      ...
      >
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            ...
            <p className="text-muted-foreground">Start your omni-channel journey today.</p>
          </div>
          ...
          >
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground text-sm">Sign up for your OmniChannel account</p>
              </div>
