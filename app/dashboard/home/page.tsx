    ...
    >
      <div className="flex flex-col gap-2">
        <div className="flex items-baseline justify-between">
          ...
          <Button className="gap-2 bg-gradient-to-r from-primary/90 to-indigo-600/90 text-primary-foreground shadow-md hover:shadow-lg">
          ...
          <CardHeader separated>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" size="sm" className="h-8 gap-1 hover:bg-primary/5 hover:text-primary hover:border-primary/30" asChild>
            ...
            <div className="space-y-2.5 mt-1">
              {recentConversations.map((convo) => (
                <motion.div 
                  ...
                  className="p-3.5 rounded-lg border bg-card/80 hover:bg-accent/5 transition-colors hover:shadow-sm hover:border-primary/10"
                >
                  <div className="flex justify-between gap-4">
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-primary/10 to-indigo-600/10 border border-primary/5 flex items-center justify-center shadow-sm">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            {convo.unread && (
                              <span className="flex-shrink-0 h-2 w-2 rounded-full bg-primary animate-pulse"></span>
                            )}
                          </div>
                          <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                            <Badge variant="outline" className="px-1.5 py-0 h-5 text-[10px] font-normal border-primary/10 bg-primary/5 text-primary/80 hover:bg-primary/10">
                              {convo.channelName}
                            </Badge>
              ...
              <div className="space-y-3.5 mt-1">
                {channelHealth.map((channel) => (
                  <motion.div 
                    key={channel.id}
                    variants={itemVariants}
                    className="flex items-center justify-between p-3 rounded-lg border bg-card/80 hover:bg-accent/5 transition-all hover:shadow-sm hover:border-primary/10"
                  >
